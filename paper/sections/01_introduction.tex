...
The remainder of this paper is organized as follows. Section~\ref{sec:related} surveys related work on knowledge editing, unlearning, and representation analysis in LLMs. Section~\ref{sec:method} presents the TDU method in detail, including our direction discovery procedure and projection-based removal mechanism. Section~\ref{sec:experiments} describes our experimental setup and presents results on unlearning benchmarks. Section~\ref{sec:analysis} provides interpretability analyses of the discovered directions. Finally, Section~\ref{sec:conclusion} discusses limitations and directions for future work.
